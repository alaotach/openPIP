...
2. Public Email: [your.email@example.com]
3. Discord Handle: [your-handle]
4. GitHub Profile: [https://github.com/your-handle]
5. Time Zone: [UTC±HH:MM]
6. University: [University Name]
7. Program and Year: [Program, Year]
8. Expected Graduation Date: [Month Year]
9. Resume: [Public Link]
