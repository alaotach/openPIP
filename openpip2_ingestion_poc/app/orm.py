...
class Interaction(Base):
    ...
    removed: Mapped[str | None] = mapped_column(String(10), nullable=True, default="0")
    binding_start: Mapped[str | None] = mapped_column(String(10), nullable=True)
    binding_end: Mapped[str | None] = mapped_column(String(10), nullable=True)
    ...
    interaction_type: Mapped[str | None] = mapped_column(Text, nullable=True)
    confidence_score: Mapped[float | None] = mapped_column(Float, nullable=True)
    publication_id: Mapped[str | None] = mapped_column(Text, nullable=True)
